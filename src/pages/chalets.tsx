  ...
  return ( 
    ...
    <section className="mt-44 sm:mt-0 container sm:px-12 mx-auto px-3 py-0 pyy-12 sm:py-20 text-start -translate-y-36 sm:-translate-y-0">
      <div className="text-start text-main-gold-dark mb-6 md:mb-12 lg:mb-20">
        <h2 className="text-3xl font-semibold sm:text-4xl md:text-5xl lg:text-6xl">شاليهات</h2>
        <p className="sm:text-lg md:text-xl max-w-xl">تمتع بالراحة والاسترخاء في شاليهات أرائك المجهزة بأحدث التقنيات والأجهزة الكهربائية، والأثاث المريح.</p>
      </div>
