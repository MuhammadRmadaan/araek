...
const Contact = () => {
  return ( 
    <section id="contact" className=" bg-main-gold-dark">
      <div className="container mx-auto px-3 sm:px-0 py-12 sm:py-20">
        ...
        <div className=" flex flex-col md:flex-row gap-16 text-start">
          ...
          <form action="" className="flex flex-col gap-3">
              ...
              <textarea rows={10} cols={45} id="message" className="bg-gray-100 outline-none border border-gray-300 text-sm rounded-lg p-3" placeholder="التفاصيل" required></textarea>
              <button type="submit" className="p-3 px-6 bg-main-gold hover:bg-main-gold-dark rounded-lg text-white">إرسال</button>
          </form>
        </div>
        <div className="flex flex-col gap-4 sm:gap-0 bg-main-gold p-8 md:p-12 xl:p-16 rounded-lg">
          <div className="child-hover:bg-main-gold-dark child:rounded-lg child:cursor-default child:p-4 child:py-2 child:sm:p-4 text-gray-200">
          ...
          <div className="flex gap-4 text-gray-200 child-hover:bg-main-gold-dark child:p-3 child:pb-1.5 child:rounded-full child:child:text-2xl">
